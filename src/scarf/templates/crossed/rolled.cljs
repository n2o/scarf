(ns scarf.templates.crossed.rolled
  (:require [om.next :as om :refer-macros [defui]]
            [om.dom :as dom]
            [scarf.templates.utils :refer [create-path scarf-background] :as utils]))

(defn- line-black [stroke-width path]
  (dom/path #js {:style #js {:stroke "#000000"
          ...
          (let [id 5001
            ...
            (dom/svg (utils/svg-options this id scale width height thumbnail?)
                     (dom/g #js {:transform (str "scale(" scale ")")}
                            ...
                            ;; Black lines to highlight stripes
                            (line-black 1.00137711 "m 454.51387,214.84155 11.29249,11.30322")
                            (line-black 1.00414312 "m 443.56118,225.82891 11.23765,11.10898"))))))
          ...
          (let [id 5008
            ...
            (dom/svg (utils/svg-options this id scale width height thumbnail?)
                     (dom/g #js {:transform (str "scale(" scale ")")}
                            ...
                            (create-path this "stripe2" s2 "m 434.41125,237.2811 10.16362,10.10316 c 0,0 200.39079,-198.50396 210.21115,-208.805368 l -24.69477,2.842663 c -4.49089,3.024778 -195.68,195.859545 -195.68,195.859545 z")
                            (create-path this "stripe2" s2 "m 475.40065,237.52772 -10.16362,10.10316 c 0,0 -199.58051,-198.614176 -209.40087,-208.915586 l 23.63227,2.78109 c 4.49088,3.02477 195.93222,196.031336 195.93222,196.031336 z")
                            (create-path this "stripe1" s1 "m 422.90757,226.19325 10.54778,10.31054 c 0,0 184.58208,-184.730935 194.40244,-195.032343 l -17.75943,1.445454 C 605.60747,45.941679 422.90757,226.19325 422.90757,226.19325 Z")
                            (create-path this "stripe1" s1 "m 486.95968,226.20291 -10.37374,10.42147 c 0,0 -184.00977,-184.412485 -193.83013,-194.713895 l 18,2.2 c 4.49088,3.02477 186.20387,182.092425 186.20387,182.092425 z")

                            ;; Small black stripes to cover the normal stripes
                            (line-black 0.99338084 "m 444.08664,227.28319 10.98622,10.93075")
                            (line-black 1.19728613 "m 454.84742,215.83388 -11.22724,11.32665")
                            (line-black 1.00086761 "m 454.47491,193.52199 22.68226,22.33337")
                            (line-black 1.04869924 "m 443.26712,204.18922 22.73235,22.83489")
                            (line-black 1.1593266 "m 432.2715,216.00405 11.23087,-11.03343"))))))
