...
(defui Calculator
  ...
  (render [this]
          (let [{:keys [scarf/mid1 scarf/mid2 scarf/stripe1 scarf/stripe2 scarf/stripe3
            ...
            (dom/div nil
                     (dom/h4 nil "Berechnungen")
                     (dom/p nil
                            (str "Du hast die Farben " (:name mid1) " und " (:name mid2) " ausgewählt."))
                                       ...
                                       (dom/table #js {:className "table table-hover table-striped table-condensed"}
                                                  ...
                                                  (dom/tbody nil
                                                             (dom/tr nil
                                                                     ...
                                                                     (dom/td nil (lib/num->currency (:price mid1))))
                                                             (dom/tr nil
                                                                     (dom/td nil 2)
                                                                     (dom/td nil (:name mid2))
                                                                     (dom/td nil (lib/num->currency (:price mid2))))
                                                             (dom/tr #js {:style #js {:borderTop "4px double lightgrey"}}
                                                                     (dom/td nil (gstring/unescapeEntities "&sum;"))
                                                                     (dom/td nil "Summe")
                                                                     (dom/td nil (lib/num->currency (+ (:price mid1) (:price mid2)))))
                                                             (dom/tr nil
